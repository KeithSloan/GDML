...
import MeshGui
import FreeCADGui
# testReplica: importing the module runs its guarded FreeCADGui.addCommand,
# registering "GDML_TestReplica".  Place testReplica.py in freecad/gdml/.
from freecad.gdml import GDMLCommands, GDMLResources, testReplica
...
class GDML_Workbench(FreeCADGui.Workbench):
    ...
    def Initialize(self):
        ...
        commands = [
            ...
            "SetScaleCommand",
            "AnalyseShapeCommand",
            "GDML_TestReplica",          # testReplica: analyse group -> Replica/ParamVol/Complex
            "TessellateCommand",
        ...
        tbTessCmds = [
            "Separator",
            "AnalyseShapeCommand",
            "GDML_TestReplica",          # testReplica: toolbar button (reuses Analyse-Shape icon)
            "TessellateCommand",
            "GmshGroupCommand",
            "DecimateCommand",
            "Mesh_FromPartShape",
